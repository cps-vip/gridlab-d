...
typedef int(TRANSLATOR)(char *local, size_t local_len, char *remote, TRANSLATIONFLAG flags, size_t remote_len, ...);
...
public:
	...
	{
		return var->obj->get_property();
	}; ///< get the property corresponding to the item
