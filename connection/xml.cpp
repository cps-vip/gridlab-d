...
// Undef Behavior: Passing enums to va_start invokes default promotion, which is no good.
int xml_translate(char *local, size_t local_len, char *remote, TRANSLATIONFLAG flag, size_t remote_len, ...)
{
	va_list ptr;
